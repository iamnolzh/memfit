    ...
    <div class="relative size-full _max-h-[320px] flex flex-col gap-3">
      ...
      <form
        ...
        classList={{
          ...
          "overflow-clip border border-border-weak-base focus-within:border-border-base transition-colors": true,
        ...
        <Show when={store.dragging}>
          <div class="absolute inset-0 z-10 flex items-center justify-center bg-surface-raised-stronger-non-alpha/90 pointer-events-none">
            <div class="flex flex-col items-center gap-2 text-text-weak">
              ...
              <span class="text-14-regular">拖放图片或 PDF 到此处</span>
            </div>
          </div>
        </Show>
        ...
        <div class="relative px-3 py-2 flex items-center justify-between">
            ...
            <Switch>
              <Match when={store.mode === "shell"}>
                <div class="flex items-center gap-2 px-2 h-6">
                  ...
                  <span class="text-12-regular text-text-primary">终端</span>
                  <span class="text-12-regular text-text-weak">退出</span>
                </div>
              </Match>
              <Match when={store.mode === "normal"}>
                <Show
                  ...
                  fallback={
                    <TooltipKeybind placement="top" title="选择模型" keybind={command.keybind("model.choose")}>
                      <Button as="div" variant="ghost" class="text-text-weak" onClick={() => dialog.show(() => <DialogSelectModelUnpaid />)}>
                ...
                >
                  <ModelSelectorPopover>
                    <TooltipKeybind placement="top" title="选择模型" keybind={command.keybind("model.choose")}>
                      <Button as="div" variant="ghost" class="text-text-weak">
                        {local.model.current()?.name ?? "选择模型"}
                        <Icon name="chevron-down" size="small" />
                      </Button>
                    </TooltipKeybind>
                ...
                <Show when={local.model.variant.list().length > 0}>
                  ...
                  >
                    ...
                    >
                      <span class="capitalize text-11-regular">{local.model.variant.current() ?? "默认"}</span>
                    </Button>
                  </TooltipKeybind>
                </Show>
              </Match>
          ...
          <div class="flex items-center gap-1">
            ...
            <Show when={store.mode === "normal"}>
              <Tooltip placement="top" value="附件">
