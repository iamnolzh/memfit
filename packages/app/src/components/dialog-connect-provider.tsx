              ...
              {iife(() => {
                ...
                return (
                  <div class="flex flex-col gap-6">
                    <Switch>
                      <Match when={provider().id === "memfit"}>
                        <div class="flex flex-col gap-4">
                          <div class="text-14-regular text-text-base">
                            MemFit Zen gives you access to a curated set of reliable optimized models for coding
                            agents.
                          </div>
                          <div class="text-14-regular text-text-base">
                          ...
                          <div class="text-14-regular text-text-base">
                            Visit{" "}
                            <Link href="https://memfit.ai/" tabIndex={-1}>
                              memfit.ai/zen
                            </Link>{" "}
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          code to connect your account and use {provider().name} models in MemFit.
                        </div>
                        <form onSubmit={handleSubmit} class="flex flex-col items-start gap-4">
                          <TextField
                            autofocus
                    ...
                    return (
                      <div class="flex flex-col gap-6">
                        <div class="text-14-regular text-text-base">
                          ...
                          connect your account and use {provider().name} models in MemFit.
                        </div>
