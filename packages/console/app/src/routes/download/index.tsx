...
export default function Download() {
  ...
  return (
    <main data-page="download">
      <Title>MemFit | Download</Title>
      <Link rel="canonical" href={`${config.baseUrl}/download`} />
      <Meta name="description" content="Download MemFit for macOS, Windows, and Linux" />
        ...
        <div data-component="content">
          <section data-component="download-hero">
            <div data-component="hero-icon">
              <img src={desktopAppIcon} alt="MemFit Desktop" />
            </div>
            <div data-component="hero-text">
              <h1>Download MemFit</h1>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[1]</span> MemFit Terminal
            </div>
            <div data-component="section-content">
              <button
                data-component="cli-row"
                onClick={handleCopyClick("curl -fsSL https://memfit.ai/install | bash")}
              >
                <code>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[2]</span> MemFit Desktop (Beta)
            </div>
            <div data-component="section-content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <div data-component="download-row">
                ...
                <a href="https://memfit.ai/docs/ide/" data-component="action-button">
                  Install
                </a>
              </div>
          ...
          <section data-component="download-section">
            <div data-component="section-label">
              <span>[4]</span> MemFit Integrations
            </div>
            <div data-component="section-content">
              <div data-component="download-row">
                <div data-component="download-info">
                ...
                <a href="https://memfit.ai/docs/github/" data-component="action-button">
                  Install
                </a>
              </div>
              ...
              <div data-component="download-row">
                ...
                <a href="https://memfit.ai/docs/gitlab/" data-component="action-button">
                  Install
                </a>
              </div>
            </div>
          ...
          <ul>
            <li>
              <Faq question="What is MemFit?">
                MemFit is an open source agent that helps you write and run code with any AI model. It's available as
            ...
            <li>
              <Faq question="Do I need extra AI subscriptions to use MemFit?">
                Not necessarily, but probably. You'll need an AI subscription if you want to connect MemFit to a paid
                provider, although you can work with{" "}
                <a href="/docs/providers/#lm-studio" target="_blank">
                  local models
                </a>{" "}
                for free. While we encourage users to use <A href="/zen">Zen</A>, MemFit works with all popular
            ...
            <li>
              <Faq question="How much does MemFit cost?">
                MemFit is 100% free to use. Any additional costs will come from your subscription to a model provider.
                While MemFit works with any model provider, we recommend using <A href="/zen">Zen</A>.
              </Faq>
            </li>
            <li>
              <Faq question="What about data and privacy?">
                Your data and information is only stored when you create sharable links in MemFit. Learn more about{" "}
