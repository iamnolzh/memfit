...
const downloadNames: Record<string, string> = {
  "darwin-aarch64-dmg": "MemFit Desktop.dmg",
  "darwin-x64-dmg": "MemFit Desktop.dmg",
  "windows-x64-nsis": "MemFit Desktop Installer.exe",
...
export async function GET({ params: { platform } }: APIEvent) {
  ...
  const resp = await fetch(`https://github.com/memfitai/memfit/releases/latest/download/${assetName}`, {
    cf: {
